...
$C_4$ is the largest constant such that, for large $n$, there exists subsets of $\mathbb{F}_3^n$ of cardinality $(C_4-o(1))^n$ that are cap sets, i.e., they do not contain any lines (length three progressions).
